...
public abstract class L2Character extends L2Object implements ISkillsHolder
{
	...
	{
		if (Config.EASY_CHAMPION_ENABLE && isEasyChampion() && (Config.EASY_CHAMPION_HP != 0))
		{
			getStatus().reduceHp(i / Config.EASY_CHAMPION_HP, attacker, awake, isDOT, false);
		}
		else if (Config.HARD_CHAMPION_ENABLE && isHardChampion() && (Config.HARD_CHAMPION_HP != 0))
		{
			getStatus().reduceHp(i / Config.HARD_CHAMPION_HP, attacker, awake, isDOT, false);
		}
		else
		{
	...
	public final L2Effect[] getAllEffectsCB()
	{
		return _effects.getAllEffectsCB();
	}
	 ...
	 * @return
	 */
	public boolean hasEffectType(L2EffectType invincible)
	{
		return false;
	}
}
