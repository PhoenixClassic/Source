...
public class In
{
	...
	public void bypass(Integer player, String command)
	{
		...
		/*
		 * else if (command.startsWith("stats ")) { Interface.statsShowHtml(Integer.parseInt(command.substring(6)),player); } else if (command.startsWith("stats_show ")) { Interface.showPlayerStats(Integer.parseInt(command.substring(11)),player); }
		 */
