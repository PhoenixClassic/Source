...
import com.l2jserver.gameserver.instancemanager.event_engine.Main;
import com.l2jserver.gameserver.instancemanager.freya.FreyaManager;
...
import com.l2jserver.gameserver.instancemanager.rank_system.rankpvpsystem.CharacterRankRewardTable;
...
import com.l2jserver.gameserver.instancemanager.rank_system.rankpvpsystem.RankRewardTable;
import com.l2jserver.gameserver.instancemanager.rank_system.rankpvpsystem.TopTable;
import com.l2jserver.gameserver.instancemanager.runes.BonusExpManager;
import com.l2jserver.gameserver.instancemanager.town_war.TownWarManager;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		printSection("Town War Event - by L2PS");
		TownWarManager.getInstance();
		//
		printSection("PvP Rank System - by Masterio");
		...
		{
			printSection("Fake PCs Loaded - by L2PS");
			FakePcsTable.getInstance();
		}
		else
		{
			printSection("Fake PCs Disabled - by L2PS");
		}
		
		if (Config.ENABLE_EVENT_ENGINE)
		{
			printSection("Events Manager Loaded - by L2PS");
			Main.main();
			Interface.start();
		}
		else
		{
			printSection("Events Manager Disabled - by L2PS");
		}
		//
		printSection("Achievements Manager Loaded - by L2PS");
		AchievementsManager.getInstance();
		//
		if (Config.PC_BANG_ENABLED)
		{
			printSection("Pc Bang System Loaded - by L2PS");
			PcCafePointsManager.getInstance();
		}
		else
		{
			printSection("Pc Bang System Disabled - by L2PS");
		}
		//
		if (Config.USE_PREMIUMSERVICE)
		{
			printSection("Premium System Loaded - by L2PS");
			PremiumManager.getInstance();
		}
		else
		{
			printSection("Premium System Disabled - by L2PS");
		}
		//
		printSection("Runes XP/SP Manager - by L2PS");
		BonusExpManager.getInstance();
		//
		printSection("Gracia Area - by L2PS");
		SoIManager.getInstance();
		SoDManager.getInstance();
		//
		printSection("Freya Grandboss Manager loaded.");
		FreyaManager.getInstance();
		//
		printSection("PrimeShop - by L2PS");
